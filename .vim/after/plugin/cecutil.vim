...
" ---------------------------------------------------------------------
"  Map Interface: {{{2
" barries: if !hasmapto('<Plug>SaveWinPosn')
" barries:  map <unique> <Leader>swp <Plug>SaveWinPosn
" barries: endif
" barries: if !hasmapto('<Plug>RestoreWinPosn')
" barries:  map <unique> <Leader>rwp <Plug>RestoreWinPosn
" barries: endif
" barries: nmap <silent> <Plug>SaveWinPosn		:call SaveWinPosn()<CR>
" barries: nmap <silent> <Plug>RestoreWinPosn	:call RestoreWinPosn()<CR>
